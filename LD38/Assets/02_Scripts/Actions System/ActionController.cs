...
{
    private PriorityQueue<long,GameAction> m_actions = new PriorityQueue<long, GameAction>(new MinComparer());
    private List<GameAction> m_activeActions = new List<GameAction>();
