...
public class Reporter : MonoBehaviour
{
    ...
    void drawToolBar()
    {
        ...
        if (showCollapseButton && GUILayout.Button(collapseContent, (collapse) ? buttonActiveStyle : barStyle, GUILayout.Width(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            collapse = !collapse;
            calculateCurrentLog();
        }
        ...
        if (showInfoButton && GUILayout.Button(infoContent, barStyle, GUILayout.Width(size.x * 2), GUILayout.Height(size.y * 2)))
        {
        ...
        if (GUILayout.Button(logContent, nonStyle, GUILayout.MinWidth(size.x), GUILayout.MaxWidth(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            showLog = !showLog;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsText, nonStyle, GUILayout.MinWidth(size.x), GUILayout.MaxWidth(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            showLog = !showLog;
            calculateCurrentLog();
        }
        ...
        if (GUILayout.Button(warningContent, nonStyle, GUILayout.MinWidth(size.x), GUILayout.MaxWidth(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            showWarning = !showWarning;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsWarningText, nonStyle, GUILayout.MinWidth(size.x), GUILayout.MaxWidth(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            showWarning = !showWarning;
            calculateCurrentLog();
        }
        ...
        if (GUILayout.Button(errorContent, nonStyle, GUILayout.MinWidth(size.x), GUILayout.MaxWidth(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            showError = !showError;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsErrorText, nonStyle, GUILayout.MinWidth(size.x), GUILayout.MaxWidth(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            showError = !showError;
            calculateCurrentLog();
        }
